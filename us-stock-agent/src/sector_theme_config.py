"""Backward-compatible module proxy for src.us.sector.theme_config."""
...
try:
    _impl = _import_module(".us.sector.theme_config", __package__)
except (ImportError, TypeError):  # direct script execution
    _impl = _import_module("us.sector.theme_config")
