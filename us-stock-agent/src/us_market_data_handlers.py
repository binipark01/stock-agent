"""Backward-compatible module proxy for src.us.market_data_handlers."""
...
try:
    _impl = _import_module(".us.market_data_handlers", __package__)
except (ImportError, TypeError):  # direct script execution
    _impl = _import_module("us.market_data_handlers")
