"""Backward-compatible module proxy for src.us.earnings_handlers."""
...
try:
    _impl = _import_module(".us.earnings_handlers", __package__)
except (ImportError, TypeError):  # direct script execution
    _impl = _import_module("us.earnings_handlers")
