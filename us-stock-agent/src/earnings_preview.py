"""Backward-compatible module proxy for src.us.earnings.preview."""
...
try:
    _impl = _import_module(".us.earnings.preview", __package__)
except (ImportError, TypeError):  # direct script execution
    _impl = _import_module("us.earnings.preview")
