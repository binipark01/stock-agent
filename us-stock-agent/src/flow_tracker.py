"""Backward-compatible module proxy for src.us.sector.flow_tracker."""
...
try:
    _impl = _import_module(".us.sector.flow_tracker", __package__)
except (ImportError, TypeError):  # direct script execution
    _impl = _import_module("us.sector.flow_tracker")
