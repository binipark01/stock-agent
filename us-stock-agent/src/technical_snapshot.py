"""Backward-compatible module proxy for src.us.technical.snapshot."""
...
try:
    _impl = _import_module(".us.technical.snapshot", __package__)
except (ImportError, TypeError):  # direct script execution
    _impl = _import_module("us.technical.snapshot")
