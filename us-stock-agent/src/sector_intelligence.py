"""Backward-compatible module proxy for src.us.sector.intelligence."""
...
try:
    _impl = _import_module(".us.sector.intelligence", __package__)
except (ImportError, TypeError):  # direct script execution
    _impl = _import_module("us.sector.intelligence")
