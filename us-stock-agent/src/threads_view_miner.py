"""Backward-compatible module proxy for src.us.social.threads_view_miner."""
...
try:
    _impl = _import_module(".us.social.threads_view_miner", __package__)
except (ImportError, TypeError):  # direct script execution
    _impl = _import_module("us.social.threads_view_miner")
