"""Backward-compatible module proxy for src.us.options_handlers."""
...
try:
    _impl = _import_module(".us.options_handlers", __package__)
except (ImportError, TypeError):  # direct script execution
    _impl = _import_module("us.options_handlers")
