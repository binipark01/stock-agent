"""Backward-compatible module proxy for src.us.news.sec_filings."""
...
try:
    _impl = _import_module(".us.news.sec_filings", __package__)
except (ImportError, TypeError):  # direct script execution
    _impl = _import_module("us.news.sec_filings")
