"""Backward-compatible module proxy for src.us.technical_handlers."""
...
try:
    _impl = _import_module(".us.technical_handlers", __package__)
except (ImportError, TypeError):  # direct script execution
    _impl = _import_module("us.technical_handlers")
