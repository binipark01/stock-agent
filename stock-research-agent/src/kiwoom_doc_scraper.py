"""Backward-compatible module proxy for kr.kiwoom.doc_scraper."""
...
try:
    _impl = _import_module(".kr.kiwoom.doc_scraper", __package__)
except (ImportError, TypeError):  # direct script execution
    _impl = _import_module("kr.kiwoom.doc_scraper")
