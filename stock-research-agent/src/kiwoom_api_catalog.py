"""Backward-compatible module proxy for kr.kiwoom.api_catalog."""
...
try:
    _impl = _import_module(".kr.kiwoom.api_catalog", __package__)
except (ImportError, TypeError):  # direct script execution
    _impl = _import_module("kr.kiwoom.api_catalog")
