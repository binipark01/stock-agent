"""Backward-compatible module proxy for kr.news.symbol_supply_news."""
...
try:
    _impl = _import_module(".kr.news.symbol_supply_news", __package__)
except (ImportError, TypeError):  # direct script execution
    _impl = _import_module("kr.news.symbol_supply_news")
