"""Backward-compatible module proxy for kr.session.flow_watch."""
...
try:
    _impl = _import_module(".kr.session.flow_watch", __package__)
except (ImportError, TypeError):  # direct script execution
    _impl = _import_module("kr.session.flow_watch")
