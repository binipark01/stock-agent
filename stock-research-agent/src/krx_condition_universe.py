"""Backward-compatible module proxy for kr.condition.universe."""
...
try:
    _impl = _import_module(".kr.condition.universe", __package__)
except (ImportError, TypeError):  # direct script execution
    _impl = _import_module("kr.condition.universe")
