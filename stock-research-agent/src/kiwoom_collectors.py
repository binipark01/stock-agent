"""Backward-compatible module proxy for kr.kiwoom.collectors."""
...
try:
    _impl = _import_module(".kr.kiwoom.collectors", __package__)
except (ImportError, TypeError):  # direct script execution
    _impl = _import_module("kr.kiwoom.collectors")
